...
<div class="container-fuild">
        ...
        <form:form class="form-horizontal" method="GET" action="/login" modelAttribute="login">
            <div class="Absolute-Center is-Responsive">
                <h3 style="margin-left: 100px;">User Login</h3>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-4">Don't have an account?</label>
                    <a href="/usersignup"><label class="control-label col-sm-1">SignUp</label></a>
                </div>
            </div>
    </div>
    </form:form>
